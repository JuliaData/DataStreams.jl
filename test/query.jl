...
for sink in (Data.Table, Data.RowTable)
    ...
    res = Data.query(df, [@NT(col=1,), @NT(col=2,), @NT(col=3,), @NT(col=4,)], sink, offset=1, limit=1)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, String, Float64, Int)
    @test Data.header(sch) == ["a", "b", "c", "d"]
    @test size(sch) == (1, 4)
    ...
    res = Data.query(df, [@NT(col=1,), @NT(col=2,), @NT(col=3,), @NT(col=4,)], sink, offset=1, limit=5)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, String, Float64, Int)
    @test Data.header(sch) == ["a", "b", "c", "d"]
    @test size(sch) == (3, 4)
    ...
    res = Data.query(df, [@NT(col=1,), @NT(col=2,), @NT(col=3,), @NT(col=4,)], sink, offset=4, limit=5)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, String, Float64, Int)
    @test Data.header(sch) == ["a", "b", "c", "d"]
    @test size(sch) == (0, 4)
    ...
    # select * where a = 2
    res = Data.query(df, [@NT(col=1, filter=x->x==2), @NT(col=2,), @NT(col=3,)], sink)
    sch = Data.schema(res)
    ...
    res = Data.query(df, [@NT(col=1, filter=x->x==2), @NT(col=2,)], sink)
    sch = Data.schema(res)
    ...
    res = Data.query(df, [@NT(col=2,), @NT(col=1, filter=x->x==2)], sink)
    sch = Data.schema(res)
    ...
    # select c
    res = Data.query(df, [@NT(col=3,)], sink)
    sch = Data.schema(res)
    ...
    res = Data.query(df, [@NT(col=3, filter=x->x < 6.0)], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Float64,)
    @test Data.header(sch) == ["c"]
    @test size(sch) == (2, 1)
    ...
    # select a + 1
    res = Data.query(df, [@NT(compute=x->x +1, computeargs=(1,))], sink)
    sch = Data.schema(res)
    ...
    res = Data.query(df, [@NT(col=3, hide=true, filter=x->x < 6.0), @NT(name=:c, compute=x->x * 2.0, computeargs=(3,))], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Float64,)
    @test Data.header(sch) == ["c"]
    @test size(sch) == (2, 1)
    ...
    res = Data.query(df, [@NT(col=3, hide=true, filter=x->x < 6.0),
                    @NT(name=:c, compute=x->x * 2.0, computeargs=(3,)),
                    @NT(name=:c2, compute=x->x / 2.0, computeargs=(3,))], sink)
    sch = Data.schema(res)
    ...
    res = Data.query(df, [@NT(col=1, group=true), @NT(name=:f, computeaggregate=(c, d)->sum(c) + sum(d), computeargs=(3, 4))], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, Float64)
    ...
    res = Data.query(df, [@NT(col=1, group=true), @NT(col=2, filter=x->x[1] == 'h', hide=true), @NT(name=:f, computeaggregate=(c, d)->sum(c) + sum(d), computeargs=(3, 4))], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, Float64)
    @test Data.header(sch) == ["a", "f"]
    @test size(sch) == (2, 2)
    ...
    # select a order by a
    res = Data.query(df, [@NT(col=1, sort=true)], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int,)
    @test Data.header(sch) == ["a"]
    @test size(sch) == (4, 1)
    ...
    res = Data.query(df, [@NT(col=1, sort=true, sortasc=false)], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int,)
    @test Data.header(sch) == ["a"]
    @test size(sch) == (4, 1)
    ...
    res = Data.query(df, [@NT(col=1, sort=true), @NT(col=2, sort=true)], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, String)
    @test Data.header(sch) == ["a", "b"]
    @test size(sch) == (4, 2)
    ...
    res = Data.query(df, [@NT(col=1, sort=true), @NT(col=2, sort=true, sortasc=false)], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, String)
    @test Data.header(sch) == ["a", "b"]
    @test size(sch) == (4, 2)
    ...
    res = Data.query(df, [@NT(col=1, sort=true, sortasc=false), @NT(col=2, sort=true, sortasc=false)], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, String)
    @test Data.header(sch) == ["a", "b"]
    @test size(sch) == (4, 2)
    ...
    res = Data.query(df, [@NT(col=1, sort=true, sortasc=false), @NT(col=2, sort=true)], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, String)
    @test Data.header(sch) == ["a", "b"]
    @test size(sch) == (4, 2)
    ...
    res = Data.query(df, [@NT(col=1, sort=true, sortindex=2, sortasc=false), @NT(col=2, sort=true, sortindex=1)], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, String)
    @test Data.header(sch) == ["a", "b"]
    @test size(sch) == (4, 2)
    ...
    res = Data.query(df, [@NT(col=1, filter=x->x==1, sort=true, sortindex=2), @NT(col=2, sort=true, sortindex=1, sortasc=false)], sink)
    sch = Data.schema(res)
    @test Data.types(sch) == (Int, String)
    @test Data.header(sch) == ["a", "b"]
    @test size(sch) == (2, 2)
